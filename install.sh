...
. .venv/bin/activate
pip install -e '.[test]'
install -m 0644 systemd/daily-radar.service /etc/systemd/system/daily-radar.service
install -m 0644 systemd/daily-radar.timer /etc/systemd/system/daily-radar.timer
